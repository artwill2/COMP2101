...
# download a zip file of pictures
test -f ~/Pictures/pics.tgz || wget -O ~/Pictures/pics.tgz https://zonzorp.net/pics.tgz

# unzip the just downloaded gzip file then remove
